// local imgs
const Onboarding = require("../assets/imgs/sobiens-first-page-background.png");
const Logo = require("../assets/imgs/sobiens-logo.png");
const LogoOnboarding = require("../assets/imgs/sobiens-logo.png");
const ProfileBackground = require("../assets/imgs/profile-screen-bg.png");
const RegisterBackground = require("../assets/imgs/register-bg.png");
const Pro = require("../assets/imgs/getPro-bg.png");
const ArgonLogo = require("../assets/imgs/sobiens-logo.png");
